...
export default function Footer() {
  return (
    ...
    <nav className=" max-w-4xl mx-auto text-center pb-4">
       <p className="text-[16px] pt-10 mb-6  p-4">Ce portfolio a été méticuleusement conçu avec ReactJS 18 et stylisé avec Tailwind CSS. Un grand merci de l'avoir consulté ! À bientôt, peut-être, pour de nouvelles opportunités passionnantes.</p>
       <ul className="flex items-center justify-center pt-8">
           ...
           <li className=" shadow-slate-600 shadow-md rounded-md sm:p-2 bg-[#dedede]"><a className="inline-block py-2 mx-3 text-2xl sm:py-0 text-black" href="/cv-alternance-septembre2024.pdf" download><IoMdDownload /></a></li>
