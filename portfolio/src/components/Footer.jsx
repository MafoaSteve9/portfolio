  ...
  return (
    ...
    <nav className=" max-w-4xl mx-auto text-center pb-4">
       ...
       <ul className="flex items-center justify-center pt-8">
           ...
           <li className=" shadow-slate-600 shadow-md rounded-md sm:p-2 bg-[#dedede]"><a className="inline-block py-2 mx-3 text-2xl sm:py-0 text-black" href="/CV-Steve.pdf" download><IoMdDownload /></a></li>
