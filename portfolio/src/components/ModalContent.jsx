  ...
  return (
    ...
    onClick={closeModal}>
        ...
        onClick={e => e.stopPropagation()}>
            ...
            <p className="sm:w-[600px] pb-2">Bonjour, je recherche une alternance de 12 mois minimum débutant à partir de septembre 2024 en tant que développeur fullstack</p>
            <ul>
