  ...
  return (
    ...
    onClick={closeModal}>
        ...
        onClick={e => e.stopPropagation()}>
            ...
            <p className="sm:w-[300px] pb-2">Bonjour, je recherche une alternance de 12 mois débutant à partir d’octobre 2023 en tant que développeur rythme 4j entreprise et 1j formation</p>
            <ul>
